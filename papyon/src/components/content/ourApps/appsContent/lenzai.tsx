  ...
  return (
    <>
      <div
        ...
        className="group/edit transition duration-500 ease-in-out relative cursor-pointer h-full border-b py-[50px] hover:bg-opacity-10 hover:bg-white border-white border-opacity-10  flex justify-between items-center"
      >
