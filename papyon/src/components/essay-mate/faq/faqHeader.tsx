...
const FaqHeader = () => {
  return (
    <div className="flex flex-col w-full justify-center items-center">
      ...
      <h1 className="text-[40px] font-semibold leading-[49px] -tracking-3 text-black">
        Frequently Asked Questions
      </h1>
      <p className="font-normal text-lg leading-8 text-center text-black text-opacity-80 ">
